    ...
    <div class='flex justify-center h-screen'>
        <div class='flex-col justify-center w-full lg:w-4/5 2xl:w-3/5'>
            <div class="flex flex-col justify-center mt-8 pt-4 px-4 md:px-16 md:text-center">
                <h1 class="text-[32px]">Criar novo produto</h1>
                <h2 class="text-[18px]">
                ...
                <form action="{{ route('products.store') }}" method="POST" class="w-full">
                    ...
                    <div class="flex flex-col justify-center">
                        <div class="flex flex-col justify-center">
                            ...
                            <input type="text" name="name" id="name" class="border border-gray-400 p-2 rounded-lg mt-2" placeholder="Nome do produto" required>
                        </div>
                        <div class="flex flex-col justify-center mt-4">
                            <label for="description" class="text-[18px]">Descrição</label>
                            <textarea name="description" id="description" cols="30" rows="10" class="border border-gray-400 p-2 rounded-lg mt-2" placeholder="Descrição do produto" required></textarea>
                        </div>
